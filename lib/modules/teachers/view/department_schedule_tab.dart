...
class _DepartmentScheduleTabState extends State<DepartmentScheduleTab> {
  ...
  Widget build(BuildContext context) {
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                ...
                child: _dayOfWeekCard(
                  index,
                  state.teachersScheduleMap[state.currentTeacher]![index + widget.tabNum * numOfDays],
                  index == currentDay,
                  dayOfWeek,
                  context,
                ),
    ...
    //final currentState = Modular.get<DepartmentBloc>().state;
    ...
    return Card(
      child: Column(
        children: [
          OutlinedButton(
            onPressed: () {
              BlocProvider.of<DepartmentBloc>(context).add(ChangeOpenedDay(dayOfWeekIndex));
            },
